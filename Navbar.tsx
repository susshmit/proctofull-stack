            ...
            {user ? (
              ...
              <>
                ...
                <Button
                  ...
                  className="rounded-lg h-8 px-3 text-xs glow-primary"
                >
            ...
            >
              <div className="px-4 py-3 space-y-1">
                ...
                <div className="flex gap-2 pt-2 border-t border-border mt-2">
                  ...
                  <Button size="sm" className="flex-1 rounded-lg h-8 text-xs" onClick={() => { navigate("/admin-login"); setMobileOpen(false); }}>
                    Admin Portal
                  </Button>
                </div>
              </div>
